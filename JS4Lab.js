...
let drink = "strawberry lemonade";

let me = "Jenni";

let friend = "Sonya";
console.log(food, drink, me, friend);
...
console.log(
   `${me} and ${friend} will eat ${food} and drink ${drink}.`
)
...
//Answer:
console.log(me + " " + "and" + " " + friend + " " + " "+ "will eat" + " " + food 
   +" " + "and" + " " + drink +".")
console.log(`-------------------------- 
Question 2a: Oh no`)
...
//Question: Read the error message - in your own words - what does it mean? I attempted to change a const, which cannot be adjusted. 
//Answer:
...
const lunchTime = (foodChoice, drinkChoice) => {return `${me} and ${friend} will eat ${foodChoice} and drink ${drinkChoice}.`};
console.log(lunchTime("salad", "water"));
console.log(lunchTime("sandwiches", "hot green tea"));


//Question: What would your function look like if we were using the old way of creating a function?
// Answer: 
// function lunchTime = (foodChoice, drinkChoice) => `${me} and ${friend} will eat ${foodChoice} and drink ${drinkChoice}.`}
...
const foodForTodayAndTomorrow = (tomorrowsFoodChoice,tomorrowsDrinkChoice, callbackFunction) => {return `${callbackFunction} Tomorrow we want ${tomorrowsFoodChoice} and drink ${tomorrowsDrinkChoice}.`};

console.log(foodForTodayAndTomorrow("hamburgers","soda"), lunchTime('newFoodItem', 'newDrinkItem'));
